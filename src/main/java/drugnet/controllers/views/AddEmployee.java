...
public class AddEmployee extends HumanResourceModel implements Initializable {
    UserAlerts ALERTS;
    ...
    public void fillEmployeeTypeSelector() {
        String [] employeeType = {"Auditor", "Cleaner","Lab Tech", "Pharmacist", "Sales Personnel", "Security"};
